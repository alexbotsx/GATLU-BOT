/**
𝘽𝙤𝙩-𝙂𝙖𝙩𝙡𝙪@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51920726588-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝘽𝙤𝙩-𝙂𝙖𝙩𝙡𝙪', 'jpegThumbnail': null } } };
